...
// Import your images
import EducationHeroImage from "@/assets/education/Education.avif";
import DentalHealthImage from "@/assets/education/Image by Nathan McBride.avif";
import HarassmentImage from "@/assets/education/Students.avif";
import DomesticViolenceImage from "@/assets/education/Education.avif";
            ...
            >
                ...
                >
                    ...
                    <img
                        ...
                        alt={t("header.education_page.hero_image_alt")}
                ...
                <div className="container relative h-full flex items-center z-20 px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        >
                            {t("header.education_page.description")}
                        </motion.p>
                        <motion.div
                ...
                <section className="mb-20 md:mb-28 px-4 sm:px-0">
                    ...
                    >
                        <span className="relative inline-block pb-2 dark:text-white">
                            {t("header.education_page.our_studies")}
                    ...
                    <div className="space-y-12 md:space-y-20">
                        ...
                        >
                            <StudyCard
                                title={t("header.education_page.dental_study.title")}
                                content={t("header.education_page.dental_study.content")}
                                actionText={t("header.education_page.view_study")}
                                imageUrl={DentalHealthImage}
                                link="#"
                                imageAlt={t("header.education_page.dental_study.image_alt")}
                                stats={[
                                    { value: "1,559", label: t("header.education_page.dental_study.stats.boys") },
                                    { value: "1,391", label: t("header.education_page.dental_study.stats.girls") },
                                    { value: "2", label: t("header.education_page.dental_study.stats.years") }
                                ]}
                            />
                        </motion.div>
                        ...
                        >
                            <StudyCard
                                title={t("header.education_page.harassment_study.title")}
                                content={t("header.education_page.harassment_study.content")}
                                supportText={t("header.education_page.harassment_study.support")}
                                imageUrl={HarassmentImage}
                                link="/projects"
                                imageAlt={t("header.education_page.harassment_study.image_alt")}
                                reverseLayout
                                stats={[
                                    { value: "2.85%", label: t("header.education_page.harassment_study.stats.reported") },
                                    { value: "18.11%", label: t("header.education_page.harassment_study.stats.policies") },
                                    { value: "21%", label: t("header.education_page.harassment_study.stats.depression") }
                                ]}
                            />
                        </motion.div>
                        ...
                        >
                            <StudyCard
                                title={t("header.education_page.violence_study.title")}
                                content={t("header.education_page.violence_study.content")}
                                supportText={t("header.education_page.violence_study.support")}
                                imageUrl={DomesticViolenceImage}
                                link="/projects"
                                imageAlt={t("header.education_page.violence_study.image_alt")}
                                stats={[
                                    { value: "8%", label: t("header.education_page.violence_study.stats.violence") },
                                    { value: "0%", label: t("header.education_page.violence_study.stats.university") },
                                    { value: "100%", label: t("header.education_page.violence_study.stats.unemployed") }
                                ]}
                            />
                        </motion.div>
                    </div>
                ...
                >
                    <div className="max-w-6xl mx-auto">
                        <motion.h3
                            ...
                            transition={{ delay: 0.2, duration: 0.8 }}
                        >
                            {t("header.education_page.impact_title")}
                        </motion.h3>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                            {[
                                { value: "3,000+", label: t("header.education_page.impact.data_points") },
                                { value: "4", label: t("header.education_page.impact.countries") },
                                { value: "3,000+", label: t("header.education_page.impact.children") }
                            ].map((stat, index) => (
                                <motion.div
                                    key={index}
                ...
                >
                    <div className="max-w-3xl mx-auto relative z-10">
                        <motion.h3
                            ...
                            transition={{ delay: 0.2, duration: 0.8 }}
                        >
                            {t("header.education_page.cta_title")}
                        </motion.h3>
                        <motion.p
                            ...
                            transition={{ delay: 0.3, duration: 0.8 }}
                        >
                            {t("header.education_page.cta_content")}
                        </motion.p>
                        <motion.div
                        ...
                        >
                            ...
                            >
                                {t("header.education_page.cta_primary")}
                            </Button>
                            <Button
                                variant="outline"
                                size="lg"
                            ...
                            >
                                {t("header.education_page.cta_secondary")}
                            </Button>
                        </motion.div>
                    </div>
